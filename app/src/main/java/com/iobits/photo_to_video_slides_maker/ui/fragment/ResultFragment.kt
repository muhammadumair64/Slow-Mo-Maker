...
import com.iobits.photo_to_video_slides_maker.databinding.FragmentResultBinding
 ...
 class ResultFragment : Fragment() {
    ...
    override fun onCreateView(
     ...
     private fun initViews(){
         ...
         binding.apply {
             if(dataShareViewModel.tabNumber == 5) { title.text = "My Videos" }
     ...
     private fun moveBack() {
         try {
             if(isAdded){
                 try {
               //  safeNavigate(R.id.action_resultFragment_to_dashboardFragment, R.id.resultFragment)
                 }catch (e:Exception){
             ...
             Log.d(TAG, "moveBack: ${e.localizedMessage}")
         }
     }
