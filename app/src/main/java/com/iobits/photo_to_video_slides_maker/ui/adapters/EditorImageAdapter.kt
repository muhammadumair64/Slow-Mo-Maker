...
import com.iobits.photo_to_video_slides_maker.databinding.ItemImageEditorBinding
...
class EditorImageAdapter(
...
) : RecyclerView.Adapter<EditorImageAdapter.MyHolder>() {
    private var mImageList: ArrayList<ImageDataClass> = ArrayList()
    var onClick: ((Int) -> Unit)? = null

    class MyHolder(val binding: ItemImageEditorBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(ItemImageEditorBinding.inflate(LayoutInflater.from(context), parent, false))
    }
